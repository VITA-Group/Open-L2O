...
class HierarchicalRNN(opt.TrainableOptimizer):
  ...
  # MODIFY
  def _compute_updates(self, params, grads, states, global_state, mode_mt,  update_steps_mt):
    ...
    with tf.variable_scope(opt.OPTIMIZER_SCOPE):
      ...
      for li, (param, grad_unflat, state) in enumerate(zip(params, grads, states)):
        ...
        with tf.variable_scope("PerTensor", reuse=self.reuse_vars):
          ...
          if self.use_attention:
            ...
            updated_param = tf.cond(mode_mt, lambda: truth - update_steps_mt[li], lambda: truth - update_step)
            ...
            updated_param = tf.cond(mode_mt, lambda: param - update_steps_mt[li], lambda: param - update_step)
    ...
    return (updated_params, updated_states, [updated_global_state],
            updated_attention, update_steps)
